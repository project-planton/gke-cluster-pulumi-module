...
import (
	...
	"github.com/plantoncloud/kube-cluster-pulumi-blueprint/pkg/gcp/container/ingress/gateway/redis"
...
func exportIpAddressOutputs(ctx *pulumi.Context, ingressIpAddress *ip.AddedIngressIpAddresses) error {
	ctx.Export(InternalIpOutputName), ingressIpAddress.Internal.Address)
	ctx.Export(ExternalIpOutputName), ingressIpAddress.External.Address)
	return nil
}
