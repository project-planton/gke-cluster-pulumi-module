...
func GetKubeClusterFolderIdOutputName(kubeClusterId string) string {
	return puluminamegcpoutput.Name(&organizations.Folder{}, kubeClusterId, wordpb.Word_id.String())
}

func GetKubeClusterFolderDisplayNameOutputName(kubeClusterId string) string {
	return puluminamegcpoutput.Name(&organizations.Folder{}, kubeClusterId, wordpb.Word_name.String())
}

func GetKubeClusterFolderParentOutputName(kubeClusterId string) string {
	return puluminamegcpoutput.Name(&organizations.Folder{}, kubeClusterId, wordpb.Word_parent.String())
}
