...
type Input struct {
	...
	ReflectorAddonInput *c2cv1deployk8cstackgcpmodel.AddonsReflector
}

func Resources(ctx *pulumi.Context, input *Input) error {
	if input.ReflectorAddonInput == nil || !input.ReflectorAddonInput.Enabled {
		return nil
	}
...
func addHelmRelease(ctx *pulumi.Context, input *Input) error {
	...
	}, pulumi.Provider(input.KubernetesProvider), pulumi.IgnoreChanges([]string{"status", "description", "resourceNames"}))
	if err != nil {
