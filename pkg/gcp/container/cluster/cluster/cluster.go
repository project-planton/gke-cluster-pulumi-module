...
import (
	"buf.build/gen/go/plantoncloud/planton-cloud-apis/protocolbuffers/go/cloud/planton/apis/v1/code2cloud/deploy/kubecluster/rpc/enums"
	...
	"github.com/plantoncloud-inc/pulumi-stack-runner-sdk/go/pulumi/name/output/custom"
...
func getClusterAutoScalingInput(input *kubernetesclusterv1state.KubeClusterGcpClusterAutoscalingConfigSpecState) container.ClusterClusterAutoscalingPtrInput {
