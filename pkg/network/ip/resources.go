...
import (
	...
	"github.com/plantoncloud/planton-cloud-apis/zzgo/cloud/planton/apis/code2cloud/v1/gcp/gkecluster/enums/ipaddressvisibility"
...
func exportOutputs(ctx *pulumi.Context, kubeClusterId string, addedIpAddresses *AddedIngressIpAddresses) {
	ctx.Export(getIngressIpOutputName
	ipaddressvisibility.IpAddressVisibility_external, kubeClusterId),
	addedIpAddresses.External.Address)
	ctx.Export(getIngressIpOutputName
	ipaddressvisibility.IpAddressVisibility_internal, kubeClusterId),
...
func getIngressIpOutputName     visibility ipaddressvisibility.IpAddressVisibility, kubeClusterId string) string {
	...
	case ipaddressvisibility.IpAddressVisibility_external:
		return GetIngressExternalIpOutputName
		kubeClusterId)
	case ipaddressvisibility.IpAddressVisibility_internal:
		return GetIngressInternalIpOutputName
		kubeClusterId)
	}
	return ""
}
